...
class DataLoader(object):
    ...
    # 4. Data Exploration 1 - outliers detection & handling
    # 5. Data scaling
    # 5. Data Exploration 2 - features statistics, feature correlation, visualization
    ...
    def __init__(self, data_input_path):
        ...
        self.x_test_valid = []
        self.params = DataLoaderParams()    # initiated with default values
    ...
    def impute_data(self):
        ...
        # -- Impute TEST data -- get only valid columns, fill NA, scale/fit
    ...
    def load_and_preprocess_data(self):
        # This method run all the preprocessing steps:
        # split train-test
